      ...
      <div className="ml-64">
        ...
        <main className="p-8">
          <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-800/50 text-center">
            <h2 className="text-xl font-semibold text-white mb-4">Página de Assinaturas</h2>
            <p className="text-gray-400">Conteúdo das assinaturas será implementado aqui.</p>
          </div>
        </main>
      </div>
    </div>
